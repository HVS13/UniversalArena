...
<table id="terminology-table">
  ...
  <tbody>
    ...
    <tr id="term-cost-floor" class="term-entry">
      <td>Cost Floor</td>
      <td>After all modifiers, a card's Energy and Ultimate Meter costs cannot go below 0.</td>
    </tr>
    ...
    <tr id="term-movement-round" class="term-entry">
      ...
      <td>A phase after Turn Start where players alternate priority. Each team gets one free swap per turn; additional swaps cost 1 Energy. Movement swaps are not card plays and do not grant Ultimate Meter. The round ends when both players pass consecutively. Rooted characters cannot be moved or swapped. See <a href="faq.md#faq-movement-round">FAQ</a>.</td>
    </tr>
    <tr class="term-section">
    ...
    <tr id="term-max-hp" class="term-entry">
      <td>Max HP</td>
      <td>The maximum HP a character can have. By default, max HP is 100 unless a scenario, mode, or character sets another value. Healing cannot raise HP above max HP.</td>
    </tr>
    ...
    <tr id="term-power-roll" class="term-entry">
      <td>Power Roll</td>
      <td>The rolled value from a card's Power used for clash comparisons, damage dealt, Shield gained, and HP recovered. Roll a uniform integer between the printed min and max (inclusive) each time a card is used.</td>
    </tr>
