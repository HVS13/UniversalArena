...
<div class="ua-entry keyword-entry" id="keyword-evade">
  ...
  <p class="ua-entry__desc">After Clash: If an Attack vs Defense clash would deal 0 Power damage after Shield, that Attack is not a hit. Reuse this card.</p>
</div>
...
<div class="ua-entry keyword-entry" id="keyword-immune">
  ...
  <p class="ua-entry__desc">Damage of the specified type becomes 0 before Shield and HP. The attack still counts as a hit unless another effect says otherwise.</p>
</div>
