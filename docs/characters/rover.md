...
<div class="card-block keyword-card">
  <ul class="keyword-card__list">
    <li class="keyword-card__item">
      ...
      <span class="keyword-card__meta"><span class="ua-pill">Max</span> 2 Count</span>
    </li>
    <li class="keyword-card__item">
      <a class="keyword-card__name" href="../../keywords/#keyword-spectro-frazzle">Spectro Frazzle</a>
      <span class="keyword-card__meta"><span class="ua-pill">Max</span> 10 Count</span>
      <ul class="keyword-card__sublist">
        <li>Turn End: Inflict damage equal to <strong>5 × Count</strong>.</li>
        <li>Then reduce Count by 1.</li>
      </ul>
    </li>
  </ul>
</div>
