...
<div class="ua-entry status-entry" id="status-cover">
  <p class="ua-entry__title">Cover</p>
  <p class="ua-entry__meta"><span class="ua-pill">Type</span> Positive.</p>
  <p class="ua-entry__meta"><span class="ua-pill">Mode</span> V.</p>
  <p class="ua-entry__meta"><span class="ua-pill">Max Value</span> 99.</p>
  <p class="ua-entry__meta"><span class="ua-pill">Before Use</span> When a single-target Attack targets an ally, change the target to this character if able and reduce <strong>Value</strong> by 1. Cover (Adjacent) only applies to adjacent allies; Cover (All) applies to any ally. Only one Cover can apply per card use; if multiple apply, the defending player chooses. Cover can redirect single-target Attacks even if they have Splash or Bounce; resolve Splash/Bounce from the new target. Cover does not affect AoE or random targeting.</p>
  <p class="ua-entry__meta"><span class="ua-pill">Turn End</span> Expires.</p>
</div>
